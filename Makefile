...
CFLAGS_COMMON = $(WARNINGS) -std=c99 -D_GNU_SOURCE -lm $(CS340)
...
test: tests/test.o tests/lib/mstats-utils.so tests/test-week1-samples.cpp tests/test-week2-testers.cpp alloc.so tests/test-pp.cpp
